...
export async function buildSweep({ force = false } = {}) {
  ...
  return {
    ...
    roster, lineup, ir, auto_subs, fa_qbs, fa_top, trending: trending.slice(0, 20), transactions, opponent, qb_depth, teams, league, env_error: envErrors.length ? envErrors.join("; ") : null, source: "live",
  };
}
