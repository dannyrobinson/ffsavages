...
{"headline": "one sentence: the single most important thing Danny should do right now, with the deadline (kickoff in Pacific time) when there is one",
 ...
 "waivers": [{"add": "name", "pos": "RB", "team": "NFL team", "drop": "name on Danny's roster", "bid": 21, "claim": true, "why": "one sentence", "urgency": "high|medium|low"}],
...
export async function runAdvisor({ trigger = "schedule", reason = "", news = "", push = true, dry = false, sweep = null, searches = 6 } = {}) {
