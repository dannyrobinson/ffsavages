...
// and pushed to Danny's phone when something needs doing. Runs four times a day (api/advise cron), when the
// 15-minute checker sees something URGENT (lib/check.js; everything else it saw waits in kv pending_reasons
// for the next run), and on demand from the app. Every run counts against ADVISE_DAILY_CAP.
