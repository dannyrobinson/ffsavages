...
export async function runAdvisor({ trigger = "schedule", reason = "", news = "", push = true, dry = false, sweep = null, searches = 10 } = {}) {
  ...
  const advice = {
    ...
    lineup: arr("lineup"), ir: arr("ir"), waivers: arr("waivers"), flags: arr("flags"), watch: arr("watch"), alerts: arr("alerts"),
